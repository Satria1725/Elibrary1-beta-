				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" class="form-control form-control-lg" name="title" required value="<?php echo isset($ftitle) ? $ftitle : '' ?>">
						</div>
					</div>
				</div>
				<div class="row">
...
$(function () {
  ...
  var myDropzone = new Dropzone(document.body, { // Make the whole body a dropzone
    ...
    acceptedFiles:'application/.xlsx,.csv,.pdf,.doc,.docx,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document',
  ...
  myDropzone.on("success",function(file,resp){
	...
	$('#manage-upload').submit(function(e){
		...
		$.ajax({
          ...
          alert_toast('Data unsuccessfully saved',"failed");
          setTimeout(function(){
						location.href = 'index.php?page=new_document'
					},2000)
        }
			}
		})
